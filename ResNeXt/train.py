...
model_weight_path = './weights/resnext50_32x4d-pre.pth'
missing_keys, unexpected_keys = model.load_state_dict(torch.load(model_weight_path,map_location="mps"),strict=False)
